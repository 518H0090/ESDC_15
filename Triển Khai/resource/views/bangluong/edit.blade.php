    ...
    @include('layout.content-header',['name'=>'Bảng Lương','key'=>'Add'])
     ...
     <div class="content">
       <div class="container-fluid">
         <div class="row">
            <div class="col-md-6">
                <form action="{{route('bangluong.update',['id'=>$bangluong->id])}}" method="POST">
                  @csrf
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name='mucluong' value='{{$bangluong->luong}}' placeholder="Mức Lương $" >
                      </div>
                      <div class="form-group">
                        <label>Mô tả</label>
